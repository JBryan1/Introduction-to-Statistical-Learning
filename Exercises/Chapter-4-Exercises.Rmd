...
We observe that returns look approximately normally distributed around zero. There are more positive gain days than negative. Volume has a positive weak correlatation with year and market direction has a postive weak correlation with today's returns.
